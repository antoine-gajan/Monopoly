export const environment = {
    ...
    */
    ...
    devolver_correo: 'http://localhost:8080/users/devolverCorreo',
    update_correo: 'http://localhost:8080/users/updateCorreo',
    update_password: 'http://localhost:8080/users/updatePassword',
    crearPartida: 'http://localhost:8080/partida/crear',
    unirJugador: 'http://localhost:8080/partida/unirJugador',
    listaJugadores: 'http://localhost:8080/partida/listaJugadores',
    lanzarDados: 'http://localhost:8080/partida/lanzarDados',
    casilla: 'http://localhost:8080/partida/casilla',
    ...
    suerteAleatoria: 'http://localhost:8080/partida/tarjeta/suerte',
    comunidadAleatoria: 'http://localhost:8080/partida/tarjeta/boletin',
};
